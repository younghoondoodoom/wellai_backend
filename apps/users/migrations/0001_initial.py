    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_deleted",
                    models.BooleanField(default=False, verbose_name="삭제 상태"),
                ),
                (
                    "deleted_at",
                    models.DateTimeField(blank=True, null=True, verbose_name="삭제 날짜"),
                ),
                (
                    "email",
                    models.EmailField(
                ...
                (
                    ...
                    models.CharField(
                        max_length=128,
                        validators=[apps.users.validators.PasswordValidator()],
                ...
                (
                    "nickname",
                    models.CharField(
                        default=apps.users.utils.get_nickname,
                        max_length=64,
                        unique=True,
                        verbose_name="닉네임",
                    ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "height",
                    models.PositiveSmallIntegerField(default=0, verbose_name="키"),
                ),
                (
                    "weight",
                    models.PositiveSmallIntegerField(default=0, verbose_name="몸무게"),
                ),
            ...
            fields=[
                ...
                (
                    ...
                    models.PositiveSmallIntegerField(
                        default=10, editable=False, verbose_name="주차"
                    ),
                ),
                (
                    "exercise_duration",
